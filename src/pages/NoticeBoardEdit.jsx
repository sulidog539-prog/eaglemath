      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden outline-none">
          <div className="p-8 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-black text-slate-900 mb-1 leading-none font-outfit">공지사항 수정</h1>
          ...
          <div className="px-8 py-6 bg-slate-50/50 flex flex-col md:flex-row gap-4 items-center justify-end border-t border-slate-100 mt-4 md:mt-0 font-outfit uppercase tracking-widest text-[10px]">
