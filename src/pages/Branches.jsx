        ...
        <div className="bg-slate-50 min-h-screen">
            ...
            <div className="bg-[#0f172a] text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight font-outfit">학원분원안내</h1>
            ...
            {/* Subject Tabs (Sticky) */}
            <div className="sticky top-[56px] lg:top-[80px] z-30 bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm transition-all duration-300 font-outfit uppercase tracking-wider text-[10px]">
